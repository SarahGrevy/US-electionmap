...
map_dots.on("load", function () {
  ...
  map_dots.on('click', 'us_counties_centroids', function (e) {
    var stateName = e.features[0].properties.State;
    var countyName = e.features[0].properties.County;
    var winner = e.features[0].properties.Winner;
    var wnrPerc = e.features[0].properties.WnrPerc;
...
map_dots.on('mouseenter', 'us_counties_centroids', function () {
    map_dots.getCanvas().style.cursor = 'pointer';
});
map_dots.on('mouseleave', 'us_counties_centroids', function () {
    map_dots.getCanvas().style.cursor = '';
});
